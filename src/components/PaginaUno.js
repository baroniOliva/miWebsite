...
function PaginaUno() {
  ...
  return (
    ...
    <div className='bodyUno'>
      ...
      <li><a href='#' onClick={()=>{setOpcionSeleccionadaWeb(null)}}> Main </a></li>
        <li><a href='#' onClick={()=>{setOpcionSeleccionadaWeb('AboutMe')}}> Acerca de Mi </a></li>
        <li><a href='#' onClick={()=>{setOpcionSeleccionadaWeb('Diplomas')}}>Mis Diplomas</a></li>
        <li><a href='#' onClick={()=>{setOpcionSeleccionadaWeb('Project')}}>Proyectos Realizados</a></li>
        <li><a href='#' onClick={()=>{setOpcionSeleccionadaWeb('Contact')}}>Contacto</a></li>
      </ul>
     </div>
